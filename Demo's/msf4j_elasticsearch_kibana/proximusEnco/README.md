...
## Functional Specs
The purpose of this application is to build a RESTApi micro service which receives the data's from LoRa device, then stores it into a stand-alone [elasticsearch](https://www.elastic.co) database. Stored data's can be retrived for analyzing and visualizing by using [Kibana](https://www.elastic.co/products/kibana).
...
Instruction can be found [here](services/msf4j/README.md)
